(() => {
  ...
  const sectionSet = [
    ...
    // section_2 : 기네스 가이드 제목 영역
    {
      ...
      vals: {
        titleA_transX: [0, 10, { start: 0.0, end: 0.7 }],
        titleB_transX: [0, 20, { start: 0.0, end: 0.7 }],
        titleC_transX: [0, -20, { start: 0.0, end: 0.7 }],
      },
    },
    ...
    // section_4 : 오프라인 매장 안내
    {
      ...
      objs: {
        ...
        info_map: document.querySelector(".sec4_map"),
      },
      vals: {},
    },
  ];
  ...
  ////// 애니메이션 범위 할당 ----------------------------------------------------------------------------
  // 즉 스크롤 위치에 따라 애니메이션의 진행도(ratio)를 계산하고, 그에 맞는 중간값(result) 도출
  ...
  const playAnimation = function () {
    ...
    let scrollRate = sectionYOffset / sectionSet[currentSection].height; // 현재 섹션에서의 스크롤 비율
    ...
    switch (currentSection) {
      ...
      case 1:
        ...
        if (scrollRate >= 0.1 && scrollRate <= 0.74) {
        ...
        } else if (scrollRate >= 0.1 && scrollRate < 0.18) {
        ...
        } else if (scrollRate >= 0.18 && scrollRate < 0.26) {
          // messageB
        ...
        } else if (scrollRate >= 0.34 && scrollRate < 0.42) {
          // messageC
        ...
        } else if (scrollRate >= 0.42 && scrollRate < 0.5) {
        ...
        } else if (scrollRate >= 0.5 && scrollRate < 0.58) {
          // messageD
        ...
        } else if (scrollRate >= 0.66 && scrollRate < 0.74) {
          // messageE
